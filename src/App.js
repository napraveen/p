...
import Features from './components/Certifications';
  ...
  return (
    <div className="App">
      <div className="home-container">
        ...
        <Body />
        <Description />
        <Features navigateToCertificates={navigateToCertificates}/>
        <Pricing />
        <Help />
        <Subscribe />
        <div className="footer">
          <div className="footer-top">
            <h2>
              Get your AI apps built with <br></br> blazing speed.
            </h2>
          ...
          <div className="footer-bottom">
            <div className="footer-left">
              <h3>GenAI</h3>
              <p>
                lorem ipsum dolor sit amet lorem<br></br> ipsum dolor sit maet
                lorem<br></br>
                ipsum dlor sit amet.
              </p>
